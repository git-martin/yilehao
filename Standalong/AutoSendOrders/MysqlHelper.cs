...
namespace AutoSendOrders
{
    ...
    public abstract class MysqlHelper
    {
        ...
        public static readonly string connectionStringManager = "server=116.62.126.46;user id=yilehao;password=yilehao@2017;database=bntweb_yilehao";//ConfigurationManager.ConnectionStrings["LocalMYSQLConnectionString"].ConnectionString;
