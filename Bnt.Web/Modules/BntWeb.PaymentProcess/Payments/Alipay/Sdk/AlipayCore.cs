...
namespace Com.Alipay
{
    ...
    public class Core
    {
        ...
        /// <param name="withQuotationMark">是否带双引号</param>
        ...
        public static string GetSign(SortedDictionary<string, string> dicArrayPre)
        {
            string sign = "";
            foreach (KeyValuePair<string, string> temp in dicArrayPre)
            {
        ...
        {
            //string strPath = RSAConfig.log_path + "\\" + "alipay_log_" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".txt";
