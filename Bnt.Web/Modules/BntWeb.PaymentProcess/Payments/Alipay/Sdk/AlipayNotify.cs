...
namespace Com.Alipay
{
    ...
    public class Notify
    {
        ...
        private readonly string _md5Key;            //MD5密钥
        private readonly string _alipayPublicKey;            //支付宝的公钥
        private readonly string _inputCharset;         //编码格式
        private readonly SignType _signType;             //签名方式
        ...
        public Notify(AlipayConfig2 config)
        {
            //初始化基础配置信息
            _partner = config.Partner.Trim();
            //_alipayPublicKey = config.AlipayPublicKey.Trim();
        ...
        {
            string veryfyUrl = Https_veryfy_url + "partner=" + _partner + "&notify_id=" + notifyId;
