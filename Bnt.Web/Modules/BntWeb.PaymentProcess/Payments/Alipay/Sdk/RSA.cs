...
namespace Com.Alipay
{
    ...
    public sealed class RSAFromPkcs8
    {
        ...
        {
            RSACryptoServiceProvider rsaCsp = LoadCertificate(privateKeyPem);
            byte[] dataBytes = null;
        ...
        private static byte[] GetPem(string type, byte[] data)
        {
            ...
            int start = pem.IndexOf(header, StringComparison.OrdinalIgnoreCase) + header.Length;
            int end = pem.IndexOf(footer, start, StringComparison.OrdinalIgnoreCase);
        ...
        public static bool Verify(string content, string signedString, string publicKey, string inputCharset)
        {
            ...
            byte[] contentData = code.GetBytes(content);
            ...
            result = rsaPub.VerifyData(contentData, sh, data);
            return result;
        }
